...
// Button input pins
#define DHTPIN_UP 3     // Digital pin connected to the DHT sensor
#define DHTPIN_LOW 5     // Digital pin connected to the DHT sensor
 ...
 * 0 = heater elements are split as a y, relay 1 and 2 is high
 ...
 * Tempature Settings
 */
int temp_top_max = 180; // Emergency high tempature
